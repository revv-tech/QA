...
router.get(
  "/validar_recuperacion/:token",
  UserController.verifyRecovery.bind(UserController)
);
router.get(
  "/validar_link/:token",
  UserController.verifyLink.bind(UserController)
);
router.put(
  "/convocado/:cedula",
  UserController.updateAttendantType.bind(UserController)
);
